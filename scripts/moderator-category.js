// Generate 6 digit number for the session ID
...
function create_category_card(categoryID, name, imagePath) {
  ...
  categoryForm.action = "moderator-quiz.html";
  ...
  var sessionIDInfo = document.createElement("input");
  sessionIDInfo.type = "hidden";
  sessionIDInfo.name = "sessionID";
  sessionIDInfo.value = sessionID;
  ...
  categoryForm.appendChild(sessionIDInfo);
